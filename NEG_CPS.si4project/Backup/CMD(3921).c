...
{ 
    ...
    if ( (SysRunState.stParam.ParaCheckSum !=  CheckSum((char *)&SysRunState.stParam,sizeof(LP_PARAM)-2))
...
void WritePara()
{
	...
	SysRunState.stParam.ParaCheckSum = CheckSum((char *)&SysRunState.stParam,sizeof(LP_PARAM)-2);//add by kevin at 20150417
...
void ACK_CMD_V(void)
{
    ...
    dr.PULSE1   = FloatToSmall(SysRunState.s_CPS.CPS1);
    dr.PULSE2   = FloatToSmall(SysRunState.s_CPS.CPS2);
    dr.PULSE3   = 0;
    printf("dr.p1 = %f\r\n",dr.PULSE1);
    #ifdef POE_SEN
    {
...
{  
	...
	SendData('F',(uint8_t*)&al,sizeof(SYS_ALARM));
} 
...
// 其他备注: 
//========================================================================
WORD CheckSum(char *buf, WORD len)
{
    BYTE dwSum = 0;
    WORD i;
