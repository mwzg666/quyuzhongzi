...
void InitParam()
{
	memset(&SysRunState.stParam,0,sizeof(LP_PARAM));
    ...
    //SysRunState.stParam.s_Jiaozhun.DET_THR_1 = 0;
    //SysRunState.stParam.s_Jiaozhun.DET_THR_2 = 0;
    //SysRunState.stParam.s_Jiaozhun.DET_THR_3 = 0;
    //SysRunState.stParam.s_Jiaozhun.DET_TIME = 0;
    //SysRunState.stParam.s_Jiaozhun.HV_THR = 0;
    #endif
...
void TimerTask()
{
    ...
    if(Timer0Cnt)
    {
        ...
        if(Time1s >= 1000)                      //100*10=1000ms
        {
            ...
            PluseCnt = ((u32)LowOverFlowFlag*65536)<<8 | (u32)(T3H*256+T3L) ;
            T3R = 0; 
            T3H = 0;
            T3L = 0;
            T3R = 1;            
